...
## Example 5: Custom reactive objects
  ...
  - You can also \alert{create your own} reactive elements from several possible data types
  - \alert{Be careful} when chaining lots of reactive elements, it can make your code hard to follow and your app possibly slow!
